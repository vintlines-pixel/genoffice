...
export const AGENT_SYSTEM_PROMPT = [
  ...
  '',
  '# Page setup',
  '- Margins, paper size, and orientation are not document blocks — change them with set_page_setup. Margins are in centimeters, or use a preset: "narrow" (1.27cm all sides), "normal" (2.54cm), "moderate" (2.54 top/bottom + 1.91 left/right), "wide" (2.54 top/bottom + 5.08 left/right). Paper is "a4" (21×29.7cm) or "letter" (21.59×27.94cm). Orientation is "portrait" or "landscape".',
  '- For "make the margins narrower" use margins "narrow"; for exact values pass marginTop/marginRight/marginBottom/marginLeft in cm. Only pass the fields the user asked to change — everything else keeps its current value.',
  '',
  '# Answer citations',
